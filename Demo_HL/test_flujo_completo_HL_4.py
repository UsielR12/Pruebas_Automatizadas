...
class TestflujocompletoHL4():
    ...
    def test_flujo_completo_HL_4(self):
        ...
        WebDriverWait(self.driver, 60).until(EC.visibility_of_element_located(
            (By.CSS_SELECTOR, ".even:nth-child(4) > td:nth-child(4)")))  # el expediente que abrimos
        WebDriverWait(self.driver, 60).until(
            EC.element_to_be_clickable((By.CSS_SELECTOR, ".even:nth-child(4) > td:nth-child(4)")))
        element1 = self.driver.find_element(By.CSS_SELECTOR, ".even:nth-child(4) > td:nth-child(4)")
        self.driver.execute_script("arguments[0].click();", element1)
